...
public class FriendshipController {
    ...
    public ResponseEntity<List<RequestFriendListDto>> getRequestFriendList(@AuthenticationPrincipal CustomUserDetails userDetails) {
        Member member = userDetails.getMember();
        List<RequestFriendListDto> result = friendshipService.getRequestFriendList(member);
