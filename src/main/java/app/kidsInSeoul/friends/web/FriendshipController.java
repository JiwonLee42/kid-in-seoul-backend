...
public class FriendshipController {
    ...
    public ResponseEntity<?> approveFriendship(@PathVariable("friendshipId") Long friendshipId, @AuthenticationPrincipal CustomUserDetails userDetails) throws Exception{
